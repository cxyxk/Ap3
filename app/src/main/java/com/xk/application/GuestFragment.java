...
public class GuestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        @SuppressLint("InflateParams") View view = inflater.inflate(R.layout.activity_guest, null);
        // 初始化数据
        ...
        g_d3.setOnClickListener(view1 -> {
            ...
            adapter.add(new Browser(dated, imageId[yuCeD3()], R.drawable.ic_solid, R.drawable.ic_d3, check[checkD3()]));
        ...
        g_s3.setOnClickListener(view12 -> {
            ...
            tzCacul.initDSValueT();
            adapter.add(new Browser(dated, imageId[yuCeD3()], R.drawable.ic_solid, R.drawable.ic_s3, check[checkS3()]));
            if (tzCacul.currentData().size() > 0) {
                tvCurrent.setText(tzCacul.currentData().get(tzCacul.currentData().size() - 1));
            }
        });
        g_d4.setOnClickListener(view13 -> {
            ...
            tzCacul.initDSValueT();
            adapter.add(new Browser(dated, imageId[yuCeD3()], R.drawable.ic_solid, R.drawable.ic_d4, check[checkD4()]));
            if (tzCacul.currentData().size() > 0) {
                tvCurrent.setText(tzCacul.currentData().get(tzCacul.currentData().size() - 1));
            }
        ...
        g_s4.setOnClickListener(view14 -> {
            ...
            tzCacul.initDSValueT();
            adapter.add(new Browser(dated, imageId[yuCeD3()], R.drawable.ic_solid, R.drawable.ic_s4, check[checkS4()]));
            if (tzCacul.currentData().size() > 0) {
                tvCurrent.setText(tzCacul.currentData().get(tzCacul.currentData().size() - 1));
            }
        });
